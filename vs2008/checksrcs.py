...
"""
checksrcs.py -- Check that all leptonica-x.xx\src\*.c & *.h files are in srcs.csv
	       and leptonica.vcproj

$RCSfile: checksrcs.py,v $ $Revision: 1.3 $ $Date: 2011/03/10 15:20:30 $
"""
