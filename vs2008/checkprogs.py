...
"""
checkprogs.py -- Check that all leptonica-1.xx\prog\*.c files are in progs.csv
		 

$RCSfile: checkprogs.py,v $ $Revision: 1.5 $ $Date: 2011/03/10 15:24:49 $
"""
...
leptonica.sln to make the subfolders in the prog_file Solution Folder
...
def checkProgs(progDir, progsFilename):
    ...
    #use following generated file to edit contents of leptonica.sln
